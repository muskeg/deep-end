...
- [ ] T092 [P] Add sound effects (pearl collection, enemy hit, game over, level complete)
...
- [ ] T097 Add pause functionality (ESC key toggles pause, freezes game state)
- [ ] T098 Implement LocalStorage for high scores and settings
- [ ] T099 Add FPS counter (debug mode, press F to toggle)
...
- [ ] T104 Update README.md with gameplay instructions and controls
